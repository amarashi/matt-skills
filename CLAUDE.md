...
[docs/repo-map.md](./docs/repo-map.md) is the complete inventory of skills, reference docs, scripts, and generated files. When adding, moving, renaming, or retiring a skill or a reference doc inside a skill folder, update it in the same change.
